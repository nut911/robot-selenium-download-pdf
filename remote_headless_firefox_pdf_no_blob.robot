...
*** Test Cases ***
Remote Headless Firefox Browser - Create Webdriver and Download PDF
  ...
  Open Browser  url=https://www.mozilla.org/en-US/foundation/documents  browser=headlessfirefox  desired_capabilities=${ff_capabilities}  options=${ff_options}
